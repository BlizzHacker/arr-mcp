...
describe('the advertised tool surface', () => {
    ...
    /** The eleven that can change something. Everything else only reads. */
    const WRITES = [
        'add_media',
    ...
    /** Of those eleven, the five whose effect crosses a destructive boundary. */
    const DESTRUCTIVE = ['delete_episode_files', 'delete_media', 'delete_request', 'manage_plugin_installation', 'remove_queue_item'];
